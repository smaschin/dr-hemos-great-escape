...
/*
 * Script modifications preformed by Spencer Maschin for Dr. Hemo's Lesser Escape on the
 * behalf of the College of Medicine at the University of Central Florida
 */
...
public class UISetup : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        UIBuilder.instance.AddLabel("Create new room:");
        UIBuilder.instance.AddTextField("");
        UIBuilder.instance.AddButton("Create", roomManager.CreateRoom);
        UIBuilder.instance.AddLabel("");
        UIBuilder.instance.AddLabel("Join existing room:");
        UIBuilder.instance.AddTextField("");
        UIBuilder.instance.AddButton("Join", roomManager.JoinRoom);
