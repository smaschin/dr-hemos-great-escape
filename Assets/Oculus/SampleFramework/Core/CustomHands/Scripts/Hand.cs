...
namespace OVRTouchSample
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public Animator networkHand = null;
        ...
        private void UpdateAnimStates()
        {
            ...
            if (networkHand)
                networkHand.SetInteger(m_animParamIndexPose, (int)handPoseId);
            ...
            if (networkHand)
                networkHand.SetFloat(m_animParamIndexFlex, flex);
            ...
            if (networkHand)
                networkHand.SetLayerWeight(m_animLayerIndexPoint, point);
